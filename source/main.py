...
# cornell_df = parseXML("../fullPDFs/2011Cornell.xml")
# smith_df = parseXML("../fullPDFs/Smith.xml")
# brown_df = parseXML("../fullPDFs/BrownCourses.xml")
# purdue_df = parseXML("../fullPDFs/Purdue.xml")
